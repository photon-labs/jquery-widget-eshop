...
require(  [ "jquery", "./OrderSuccess", "qunit" ], function($, OrderSuccess, QUnit) {
	...
	testOrderSuccessSametext("Test OrderSuccess with same text.", function() {
	...
	testOrderSuccessdiffText("Test OrderSuccess with different text.", function() {
