...
require([ "jquery", "./OrderForm", "./EShopAPI", "./Phresco", "qunit" ], function($, OrderForm, EShopAPI, Phresco, QUnit) {
	...
	testOrderFormSuccess("Test order form with similar data", function() {
	...
	testOrderFormWithDiffData("Test order form with different data", function() {
