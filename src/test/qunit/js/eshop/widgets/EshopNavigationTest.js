...
require(  [ "jquery", "./Navigation", "./EShopAPI", "./Phresco", "qunit" ], function($, Navigation, EShopAPI, Phresco, QUnit) {
	...
	testNavigationSuccess("Test Navigation with login same data.", function() {
	...
	testNavigationFailure("Test Navigation without login Different data.", function() {
	...
	testNavigationFailure("Test Navigation with login Different data.", function() {
