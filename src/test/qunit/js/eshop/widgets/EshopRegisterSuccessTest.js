...
require(  [ "jquery", "./RegisterSuccess", "./EShopAPI", "./Phresco", "qunit" ], function($, RegisterSuccess, EShopAPI, Phresco, QUnit) {

	var equal = QUnit.equal, notEqual = QUnit.notEqual, expect = QUnit.expect, testRegisterSuccessSuccessMsg = QUnit.test, testRegisterSuccessFailureMsg = QUnit.test, resgisterresponse1, register1, register, output1, output2;
	
	testRegisterSuccessSuccessMsg("Test RegisterSuccess for success case", function() {
		var registerSuccess, api, phrescoapi, resgisterresponse, output1, mainContent, contactus, selection, divleft, contactdescrip, myCart, log_div, log_innerdiv, log_innerdiv1, log_heading, log_txt_div, registrationStatus, userStatus, userstatusMsg, statusMsg, log_txtEmail, log_txt_lftEmail, log_txtfname, log_txt_lftfname, log_txt_rhtfname, cleardiv, log_txt_rhtEmail;
	...
	testRegisterSuccessFailureMsg("Test RegisterSuccess for failure case", function() {
		var registerSuccess, api, phrescoapi, resgisterresponse, output1, mainContent, contactus, selection, divleft, contactdescrip, myCart, log_div, log_innerdiv, log_innerdiv1, log_heading, log_txt_div, registrationStatus, userStatus, userstatusMsg, statusMsg, log_txtEmail, log_txt_lftEmail, log_txtfname, log_txt_lftfname, log_txt_rhtfname, cleardiv, log_txt_rhtEmail;
