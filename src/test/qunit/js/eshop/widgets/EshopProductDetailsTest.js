...
require([ "jquery", "./ProductDetails", "./EShopAPI", "./WSConfig", "qunit" ], function($, ProductDetails, EShopAPI, WSConfig, QUnit) {
...
var equal = QUnit.equal, expect = QUnit.expect, notEqual = QUnit.notEqual, testWithSameProductId = QUnit.test, testWithDifferentProductId = QUnit.test, wsconfig;
	...
	testWithSameProductId("Test Product details with same ProductID.", function() {
		...
		ratingStarSpan, starImage1, starValue, starValueBox, obj, loginAlertForm, productId, productdetail, api, listener, output1, output2, pid;
		...
		output1 = productdetail.renderUI();
	...
	testWithDifferentProductId("Test Product details with different Product ID.", function() {
		...
		notEqual(output1.html(), output2.html(), "Test Product details with different ProductID - Test case passed "); 
	});
});
