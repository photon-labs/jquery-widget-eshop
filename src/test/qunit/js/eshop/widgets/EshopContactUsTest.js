...
require(  [ "jquery", "./Contactus", "qunit" ], function($, Contactus, QUnit) {
	...
	testContactUsFailure("Test Contactus with different text.", function() {
		var contactus, output1, output2, mainContent, aboutus, selection, divleft, h3title, contactdescrip, h4title, ptag, cleardiv;
