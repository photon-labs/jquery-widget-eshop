...
require([ "jquery", "./OrderFormView", "./Phresco", "qunit" ], function($, OrderFormView, Phresco, QUnit) {
	...
	testOrderFormViewSuccess("Test order form view with similar data", function() {
		...
		output1 = orderFormView.renderUI();
	...
	testOrderFormViewDiffData("Test order form view with different data", function() {
