...
require([ "jquery", "./MyCart", "./EShopAPI", "./Phresco", "qunit" ], function($, MyCart, EShopAPI, Phresco, QUnit) {
	 ...
	 */
	testMycartSuccess("Test MyCart with same quantity.", function() {
	...
	testMycartFail("Test MyCart with Different quantity", function() {
