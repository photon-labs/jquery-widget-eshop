...
require(  [ "jquery", "./LoginSuccess", "./EShopAPI", "./Phresco", "qunit" ], function($, LoginSuccess, EShopAPI, Phresco, QUnit) {
	...
	testLoginSuccessSuccess("Test LoginSuccess with success case.", function() {
	...
	testLoginSuccessFailure("Test LoginSuccess with Failure case.", function() {
