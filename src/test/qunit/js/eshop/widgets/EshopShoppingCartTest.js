...
require(  [ "jquery", "eshop/widgets/ShoppingCart", "eshop/widgets/EShopAPI", "eshop/widgets/Phresco", "eshop/widgets/WSConfig", "qunit" ], function($, ShoppingCart, EShopAPI, Phresco, WSConfig, QUnit) {

	var equal = QUnit.equal, notEqual = QUnit.notEqual, wsconfig, expect = QUnit.expect, test = QUnit.test, testShoppingCartWithDiffProdSet = QUnit.test, testShoppingCartWithDiffData = QUnit.test, testShoppingCartSuccess = QUnit.test, testShoppingCartFailure = QUnit.test, self = this, api, phrescoapi, output1, output2;

	/**
	 * Test that the setMainContent method sets the text in the shoppingcart-widget
	 */
	
	testShoppingCartSuccess("Test Shopping cart", function() {
	...
	testShoppingCartWithDiffProdSet("Test Shopping cart with different product sets", function() {
