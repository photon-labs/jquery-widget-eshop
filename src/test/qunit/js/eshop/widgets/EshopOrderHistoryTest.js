...
require(  [ "jquery", "./OrderHistory", "./EShopAPI", "qunit" ], function($, OrderHistory, EShopAPI, QUnit) {
	...
	testOrderHistorySuccess("Test OrderHistory with same data.", function() {
	...
	testOrderHistoryFailure("Test OrderHistory with different data.", function() {
