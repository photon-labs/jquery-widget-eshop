...
require(  [ "jquery", "eshop/widgets/ShoppingCart", "eshop/widgets/EShopAPI", "eshop/widgets/Phresco", "eshop/widgets/WSConfig"], function($, ShoppingCart, EShopAPI, Phresco, WSConfig) {
	...
	test("Test Shopping cart", function() {
	 ...
	 test("Test Shopping cart - mismatch case", function() {
	...
	test("Test Shopping cart  with different data", function() {
	...
	test("Test Shopping cart with different product sets", function() {
