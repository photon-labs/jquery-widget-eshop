...
define( "eshop/widgets/ProductDetails", [ "jquery", "framework/Clazz", "framework/Widget" ], function($, Clazz, Widget) {
    ...
    ProductDetails.prototype.setMainContent = function() {
		...
		self = this, mainContent, topH3, productContainer, productDetails, productname, productimageholder,
		...
		ratingStarSpan, starImage1, starValue, starValueBox, obj, loginAlertForm, productId;
